...
export const HeroSection = () => {
  ...
  return (
    <section className='section xl:bg-herp-xl w-full h-[100vh] bg-dark-blue bg-hero-xl py-0 md:bg-hero-md lg:bg-hero-lg xl:bg-hero-xl'>
      <div className='relative size-full bg-mscope-img bg-mscope-sm bg-no-repeat pb-[80px] pt-[13vh] md:container max-lg:pb-0 md:pt-[20vh] md:bg-mscope-md lg:pt-[162px] lg:bg-mscope-lg xl:bg-mscope-xl xl:px-0'>
        <Image
        ...
        >
          <div className='mt-[-11px] flex flex-col items-center justify-start px-4 font-exo_2 text-white-dis md:w-[500px] md:items-start md:px-0'>
            <h2 className=' text-xl md:text-2xl lg:text-3xl font-bold leading-none xl:text-title'>
              Бачимо гаджети
            </h2>
            <h3 className='text-3xl lg:text-4xl font-bold leading-none text-mid-blue drop-shadow-banner xl:text-9xl'>
              наскрізь
            </h3>

            <p className='mt-[22px] text-sm font-inter leading-none tracking-title lg:mt-11 lg:text-xl md:tracking-normal'>
              Мережа студій ремонту твоєї техніки
            </p>

            <div className='mt-[20px] w-[280px] lg:mt-[48px] md:w-[300px] xl:w-[336px]'>
          ...
          <div className='overflow-x-hidden md:max-w-[350px] lg:max-w-[411px] lg:pt-[54px]'>
            <h3 className='heading-none relative mx-3 border-b-2 border-pros-bg pb-[10px] align-top font-exo_2 text-xl md:text-lg lg:text-xl tracking-middle text-white-dis md:mx-0'>
