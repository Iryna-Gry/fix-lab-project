...
const CommonButton: React.FC<ICommonButtonProps> = ({
  ...
  >
    <span className='animate-slide-bottom font-inter text-base font-semibold leading-none tracking-wide text-[#04268b] md:text-sm lg:text-base group-hover:animate-slide-top'>
      {children}
    </span>
  </button>
)
