  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'not-found-desctop': "url('/images/background404-desctop.png')",
        'not-found-tablet': "url('/images/background404-tablet.png')",
        'not-found-phone': "url('/images/phone-background404.png')",
